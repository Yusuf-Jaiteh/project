        ...
        <CartProvider>
          <Navbar/>
            <Routes>
              ...
              <Route path='/admin/add-categories' element={<AdminRoute element={<AddCategory/>} />} />
              <Route path='/admin/edit-categories/:categoryId' element={<AdminRoute element={<EditCategory/>} />} />
